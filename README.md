...
<details>
  ...
  В особенности: <br/>
      tensorflow > 2.0.0 (лучше 2.3.0) <br/>
      tesserocr (вместе с tesseract, который должен установится по умолчанию вместе с tesserocr) <br/>
      pdf2image <br/>
      fuzzywuzzy (используется для сравнения текста) <br/>
